...
TheadLocalTokenBucket::TheadLocalTokenBucket(
    ...
    : impl_slot_ptr_(TypedSlot::makeUnique(context.threadLocal())), impl_slot_ref_(*impl_slot_ptr_),
      main_dispatcher_(context.dispatcher()) {
